                ...
                <div class="capitulo-acoes">
                    ${capitulo.disponivel ? `
                        <div class="modulos-container">
                            ...
                            ${capitulo.simulado ? `<button class="btn-simulado" onclick="iniciarProvaSimulada('${capitulo.id}')">📝 ${capitulo.geniusGames ? (capitulo.geniusLessons && capitulo.irregularVerbsList && capitulo.questoes2 ? '9' : capitulo.geniusLessons || capitulo.irregularVerbsList || capitulo.questoes2 ? '8' : '7') : capitulo.geniusLessons ? (capitulo.irregularVerbsList && capitulo.questoes2 ? '8' : capitulo.irregularVerbsList || capitulo.questoes2 ? '7' : '6') : capitulo.irregularVerbsList ? (capitulo.questoes2 ? '7' : '6') : capitulo.questoes2 ? '6' : '5'}. Prova Simulada</button>` : ''}
                        </div>
                    ` : `
